nvidia-docker run -it --name $1 --net=host -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix:rw -v "$HOME/.Xauthority:/root/.Xauthority:rw" -e PASSWORD=123 -v /home/ersin:/host ersin/tensorflow_torch:1.4.0_8 /bin/bash
